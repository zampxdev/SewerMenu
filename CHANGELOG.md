...
- Reworked Shift+K command palette that can open from gameplay, toggle features, inspect matches, spawn matching items, and close from a typed `close` command.
